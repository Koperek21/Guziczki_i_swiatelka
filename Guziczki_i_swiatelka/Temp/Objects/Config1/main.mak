...
export WIN32_AS_PROJECT_PATH := "C:\Praktyki\Guziczki i swiatelka\Guziczki_i_swiatelka"
...
export WIN32_AS_TEMP_PATH := "C:\Praktyki\Guziczki i swiatelka\Guziczki_i_swiatelka\Temp"
export WIN32_AS_BINARIES_PATH := "C:\Praktyki\Guziczki i swiatelka\Guziczki_i_swiatelka\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/Guziczki_i_swiatelka.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'BuildAndTransfer'   
